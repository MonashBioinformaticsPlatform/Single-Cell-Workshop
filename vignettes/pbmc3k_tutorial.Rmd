...
**Side Bar Challenge**
The count matrix represents all the cells in the sample (columns) and the genes (rows), why would most
count values of genes in cells be zero?
