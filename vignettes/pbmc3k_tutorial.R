## "Seurat & Monocle - Guided Clustering Tutorial

# This content is the Seurat PBMC tutorial: https://satijalab.org/seurat/articles/pbmc3k_tutorial.html
# with an additional section to add in Monocle for pseudotime trajectory analysis.
# 
# Please go to the installation page: https://monashbioinformaticsplatform.github.io/Single-Cell-Workshop/installation.html 
# for instructions on how to install the libraries used for this workshop.
# There are also instructions for downloading the raw data: http://cf.10xgenomics.com/samples/cell/pbmc3k/pbmc3k_filtered_gene_bc_matrices.tar.gz
...
# **Where are QC metrics stored in Seurat?**</summary>
...
#   
#   Are the thresholds we set, reasonable? 
#   What happens if we relax the thresholds? 
#   Lets plot the percent mt with number of features.

plot3 <- FeatureScatter(pbmc, feature1 = "nFeature_RNA", feature2 = "percent.mt") 
plot3

#   
#   Okay we are happy with our thresholds, lets apply them and subset our data. This will remove
